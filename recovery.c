    ...
    for (;;) {
        ...
        if (chosen_item >= 0) {
            ...
            if (confirm_apply == BTN_MOUSE) {
                            ...
                            ui_print("\nRestoring : ");
       		            char nandroid_command[200]="/sbin/nandroid-mobile.sh -r --norecovery --nocache --nomisc --nosplash1 --nosplash2 --defaultinput -s ";
...
#define ITEM_WIPE_BAT      2
#define ITEM_WIPE_ROT      3
